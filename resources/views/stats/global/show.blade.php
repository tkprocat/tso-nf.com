...
<script>
    ...
    function loadData() {
        $.get("/stats/global/getPlayedCountForLast30Days/{{ urlencode($adventure->name) }}", function(json) {
            chart.addSeries({
                name: "Play count",
                data: json
            });
    ...
    $.get("/stats/getLast30Days", function(weeks) {
        chart = new Highcharts.Chart({
            ...
            title: {
                text: 'Number of times the adventure have been played per day for the last month'
            },
            xAxis: {
                title: {
                    text: 'Week'
